...
import com.dongruan.graduation.networkdiskcommon.exception.CacheException;
...
public class JedisClusterUtil {
    ...
    public JedisClusterUtil(String cnodes) {
//        this.jedisCluster = getJedisClusterObj(cnodes, password);
        this.jedisCluster = getJedisClusterObj(cnodes);
    }
     ...
     * 从连接池中获取链接
     */
    public JedisCluster getJedisClusterObj(String clusterNodes) {
...
//        JedisCluster jedisCluster = new JedisCluster(nodes, connectionTimeout, soTimeout, maxAttempts, password, poolConfig);
        JedisCluster jedisCluster = new JedisCluster(nodes, connectionTimeout, soTimeout, maxAttempts, poolConfig);
        return jedisCluster;
    }
