...
function ajax() {
    var a = $(this).data("key");
    if (a == "all") {
        location.href = "http://47.110.83.145:8082/" + "#/" + a + "?path=/"
    } else {
        if (a == "myShare") {
            location.href = "http://47.110.83.145:8086/share/manage/" + $("#uid").val() + "/"
        } else {
            location.href = "http://47.110.83.145:8082/" + "#/" + a
        }
    }
}
...
function exit() {
    location.href = "http://47.110.83.145:8080/"
    // $("#my-confirm").modal({
                        ...
                        if (g.respCode == 0) {
                            ...
                            $.ajax({
                                ...
                                success: function (h) {
                                    if (h.respCode == 1) {
                                        alert("修改成功");
                                        location.href = "http://47.110.83.145:8086/"
                                    } else {
                                        alert(h.respMsg);
                                    }
                                },
        ...
        closeViaDimmer: 0, onConfirm: function (c) {
            ...
            if (e != "PNG" && e != "GIF" && e != "JPG" && e != "JPEG" && e != "BMP") {
                ...
                if (parseInt(b) >= parseInt(g)) {
                    ...
                    f.append("file", d);
                    $.ajax({
                        url: "http://47.110.83.145:8095/api/user/uploadPic",
                        type: "post",
                        contentType: false,
                        data: f,
                        cache: false,
