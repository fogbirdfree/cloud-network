...
import com.dongruan.graduation.networkdiskssoclient.util.Oauth2Utils;
...
public class LoginFilter extends ClientFilter {
	...
	public boolean isAccessAllowed(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (sessionAccessToken != null && (!sessionAccessToken.isExpired()
			...
			String encodeCookie = URLEncoder.encode(JSONObject.toJSONString(sessionAccessToken.getUser()), "utf-8");
	 ...
	 * @return
	 */
	boolean refreshToken(String refreshToken, HttpServletRequest request) {
    ...
    void responseJson(HttpServletResponse response, int code, String message) throws IOException {
